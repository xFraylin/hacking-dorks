...
const dorkCategories: DorkCategory[] = [
  ...
  // ── Git Exposed ───────────────────────────────────────────────────────────
  {
    title: "Git Exposed",
    dorks: [
      // Directorio .git accesible directamente
      `site:{domain} inurl:"/.git/HEAD"`,
      `site:{domain} inurl:"/.git/config"`,
      `site:{domain} inurl:"/.git/index"`,
      `site:{domain} inurl:"/.git/COMMIT_EDITMSG"`,
      `site:{domain} inurl:"/.git/logs/HEAD"`,
      `site:{domain} inurl:"/.git/description"`,
      `site:{domain} inurl:"/.git/FETCH_HEAD"`,
      `site:{domain} inurl:"/.git/ORIG_HEAD"`,
      `site:{domain} inurl:"/.git/packed-refs"`,
      `site:{domain} inurl:"/.git/refs/heads/"`,
      `site:{domain} inurl:"/.git/refs/remotes/"`,
      `site:{domain} inurl:"/.git/refs/tags/"`,
      `site:{domain} inurl:"/.git/info/exclude"`,
      `site:{domain} inurl:"/.git/info/refs"`,
      `site:{domain} inurl:"/.git/info/packs"`,
      `site:{domain} inurl:"/.git/" intitle:"Index of"`,
      `site:{domain} intitle:"Index of /.git"`,
      // Contenido del .git/config con credenciales
      `site:{domain} inurl:"/.git/config" intext:"[remote"`,
      `site:{domain} inurl:"/.git/config" intext:"repositoryformatversion"`,
      `site:{domain} inurl:"/.git/config" intext:"url = https://"`,
      `site:{domain} inurl:"/.git/config" intext:"[branch"`,
      `site:{domain} inurl:"/.git/config" intext:"[credential]"`,
      // Objetos y pack files Git
      `site:{domain} inurl:"/.git/objects/pack/" ext:pack`,
      `site:{domain} inurl:"/.git/objects/pack/" ext:idx`,
      `site:{domain} inurl:"/.git/objects/" intitle:"Index of"`,
      // Archivos .gitconfig con datos del usuario
      `site:{domain} inurl:"/.gitconfig" intext:"[user]"`,
      `site:{domain} intext:"[user]" intext:"name=" intext:"email=" filetype:gitconfig`,
      `site:{domain} inurl:"/.gitconfig" intext:"email ="`,
      // Archivos .gitignore con rutas sensibles indexadas
      `site:{domain} filetype:gitignore intext:".env"`,
      `site:{domain} filetype:gitignore intext:"config.php"`,
      `site:{domain} filetype:gitignore intext:"id_rsa"`,
      `site:{domain} filetype:gitignore intext:"secrets"`,
      `site:{domain} filetype:gitignore intext:"credentials"`,
      `site:{domain} filetype:gitignore intext:"private.key"`,
      `site:{domain} filetype:gitignore intext:".pem"`,
      // .gitmodules con submódulos internos
      `site:{domain} inurl:".gitmodules" intext:"[submodule"`,
      `site:{domain} filetype:gitmodules intext:"url ="`,
      // .gitattributes
      `site:{domain} inurl:"/.gitattributes"`,
      // Credenciales en .git-credentials / .netrc
      `site:{domain} inurl:"/.git-credentials"`,
      `site:{domain} intext:"machine github.com" intext:"login" filetype:netrc`,
      `site:{domain} filetype:netrc intext:"machine" intext:"password"`,
      `site:{domain} inurl:"/.netrc" intext:"machine"`,
      // Tokens GitHub (PAT) expuestos
      `site:{domain} intext:"ghp_" ext:txt | ext:log | ext:env`,
      `site:{domain} intext:"gho_" ext:txt | ext:log`,
      `site:{domain} intext:"ghu_" ext:txt | ext:log`,
      `site:{domain} intext:"ghs_" ext:txt | ext:log`,
      `site:{domain} intext:"ghr_" ext:txt | ext:log`,
      `site:{domain} intext:"github_token" | intext:"GITHUB_TOKEN"`,
      `site:{domain} intext:"github.com" intext:"token" filetype:yml | filetype:yaml`,
      // Tokens GitLab expuestos
      `site:{domain} intext:"glpat-" ext:txt | ext:log | ext:env`,
      `site:{domain} intext:"GITLAB_TOKEN" | intext:"CI_JOB_TOKEN"`,
      `site:{domain} intext:"private_token" inurl:"gitlab"`,
      // CI/CD con secrets hardcodeados
      `site:{domain} filetype:yml inurl:".github/workflows" intext:"secret"`,
      `site:{domain} filetype:yml inurl:".github/workflows" intext:"token"`,
      `site:{domain} filetype:yml inurl:".github/workflows" intext:"password"`,
      `site:{domain} inurl:".gitlab-ci.yml" intext:"password"`,
      `site:{domain} inurl:".gitlab-ci.yml" intext:"secret"`,
      `site:{domain} inurl:".travis.yml" intext:"env:" intext:"secure:"`,
      `site:{domain} inurl:".travis.yml" intext:"password" | intext:"api_key"`,
      `site:{domain} inurl:".circleci/config.yml" intext:"password"`,
      `site:{domain} inurl:"Jenkinsfile" intext:"credentials"`,
      `site:{domain} inurl:"Jenkinsfile" intext:"withCredentials"`,
      `site:{domain} inurl:".drone.yml" intext:"secret"`,
      `site:{domain} inurl:"bitbucket-pipelines.yml" intext:"password"`,
      `site:{domain} filetype:yml intext:"GITHUB_TOKEN" | intext:"GITLAB_TOKEN"`,
      // Deploy keys y SSH keys en repositorios
      `site:{domain} intext:"-----BEGIN RSA PRIVATE KEY-----" filetype:txt`,
      `site:{domain} intext:"-----BEGIN OPENSSH PRIVATE KEY-----" filetype:txt`,
      `site:{domain} intext:"-----BEGIN EC PRIVATE KEY-----" filetype:txt`,
      `site:{domain} intext:"-----BEGIN DSA PRIVATE KEY-----" filetype:txt`,
      `site:{domain} inurl:".ssh" filetype:pub`,
      `site:{domain} inurl:"id_rsa" | inurl:"id_dsa" | inurl:"id_ecdsa" | inurl:"id_ed25519"`,
      `site:{domain} inurl:"deploy_key" | inurl:"deployment_key"`,
      // Exposición SVN
      `site:{domain} inurl:"/.svn/entries"`,
      `site:{domain} inurl:"/.svn/wc.db"`,
      `site:{domain} inurl:"/.svn/" intitle:"Index of"`,
      `site:{domain} inurl:"/.svn/format"`,
      `site:{domain} intext:"SVN" inurl:"/.svn/pristine/"`,
      // Exposición Mercurial / Bazaar / CVS
      `site:{domain} inurl:"/.hg/" intitle:"Index of"`,
      `site:{domain} inurl:"/.hg/hgrc"`,
      `site:{domain} inurl:"/.hg/store/" intitle:"Index of"`,
      `site:{domain} inurl:"/.bzr/" intitle:"Index of"`,
      `site:{domain} inurl:"/.bzr/branch/format"`,
      `site:{domain} inurl:"/CVS/Root" | inurl:"/CVS/Entries"`,
      // Búsqueda en GitHub/GitLab/Bitbucket de repos con datos sensibles
      `site:github.com "{domain}" intext:"password"`,
      `site:github.com "{domain}" intext:"api_key" | intext:"api_secret"`,
      `site:github.com "{domain}" intext:"BEGIN RSA PRIVATE KEY"`,
      `site:github.com "{domain}" intext:"db_password" | intext:"database_password"`,
      `site:github.com "{domain}" intext:"secret_key" | intext:"SECRET_KEY"`,
      `site:github.com "{domain}" filetype:env intext:"DB_"`,
      `site:github.com "{domain}" filetype:env intext:"AWS_"`,
      `site:github.com "{domain}" filetype:json intext:"client_secret"`,
      `site:gitlab.com "{domain}" intext:"password"`,
      `site:gitlab.com "{domain}" intext:"private_token"`,
      `site:bitbucket.org "{domain}" intext:"password" | intext:"secret"`,
      // Archivos .env y configuración en repos públicos
      `site:{domain} inurl:"/.env" intext:"DB_PASSWORD"`,
      `site:{domain} inurl:"/.env" intext:"APP_KEY"`,
      `site:{domain} inurl:"/.env" intext:"AWS_SECRET"`,
      `site:{domain} inurl:"/.env.production"`,
      `site:{domain} inurl:"/.env.staging"`,
      `site:{domain} inurl:"/.env.backup"`,
      // Git archive / dumps / clones accidentales
      `site:{domain} inurl:"/repo.git" | inurl:"/project.git"`,
      `site:{domain} inurl:".git.zip" | inurl:".git.tar.gz" | inurl:".git.rar"`,
      `site:{domain} intitle:"Index of" "git-pack-*.pack"`,
      `site:{domain} intext:"gitdir:" filetype:git`,
      // Indicadores de herramientas de dump Git
      `intext:"git-dumper" site:{domain}`,
      `site:{domain} inurl:"/git-bundle" | inurl:"/repo-bundle"`,
      // Información de ramas y commits expuesta
      `site:{domain} intext:"commit" intext:"Author:" intext:"Date:" filetype:txt`,
      `site:{domain} inurl:"/.git/logs/" intitle:"Index of"`,
      `site:{domain} inurl:"/.git/logs/refs/" intitle:"Index of"`,
    ],
    icon: <Github className="h-4 w-4" />,
    description: "Repositorios Git expuestos — .git accesible, configs con credenciales, tokens CI/CD, SVN/HG/BZR, secrets en repos públicos y deploy keys filtradas",
