...
const dorkCategories: DorkCategory[] = [
  ...
  {
    title: "IDOR — Object Reference Parameters",
    dorks: [
    ...
    icon: <Eye className="h-4 w-4" />,
    description: "Parámetros de referencia directa a objetos — candidatos a IDOR",
    color: "bg-violet-500/10 text-violet-600 border-violet-500/20",
    group: "Web Vulns"
  },
  {
    title: "IDOR — API & REST Endpoints",
    dorks: [
      `site:{domain} inurl:"/api/user/"`,
      `site:{domain} inurl:"/api/users/"`,
      `site:{domain} inurl:"/api/account/"`,
      `site:{domain} inurl:"/api/order/"`,
      `site:{domain} inurl:"/api/orders/"`,
      `site:{domain} inurl:"/api/profile/"`,
      `site:{domain} inurl:"/api/invoice/"`,
      `site:{domain} inurl:"/api/document/"`,
      `site:{domain} inurl:"/api/v1/" inurl:"?id="`,
      `site:{domain} inurl:"/api/v2/" inurl:"?id="`,
      `site:{domain} inurl:"/rest/" inurl:"?id="`,
      `site:{domain} inurl:"/v1/users/" | inurl:"/v2/users/"`,
      `site:{domain} inurl:"/api/" inurl:"/me/"`,
      `site:{domain} inurl:"/api/" inurl:"/admin/"`,
    ],
    icon: <Eye className="h-4 w-4" />,
    description: "Endpoints REST y API con rutas que exponen IDs de objetos — IDOR en APIs",
    color: "bg-violet-500/10 text-violet-600 border-violet-500/20",
    group: "Web Vulns"
  },
]
